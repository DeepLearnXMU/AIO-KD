...
class FairseqTask(object):
    ...
    def build_generator(
        ...
        # adaptive decoding layer
        encoder_layer_to_infer = getattr(args, "encoder_layer_to_infer", None)
        decoder_layer_to_infer = getattr(args, "decoder_layer_to_infer", None)
        extra_gen_cls_kwargs["encoder_layer_to_infer"] = encoder_layer_to_infer
        extra_gen_cls_kwargs["decoder_layer_to_infer"] = decoder_layer_to_infer        
        print(encoder_layer_to_infer, decoder_layer_to_infer) 
        return seq_gen_cls(
            models,
            self.target_dictionary,
