...
def add_generation_args(parser):
    ...
    # selected encoder/decoder layer for generation
    #group.add_argument("--encoder-layer-to-infer", type=int, default=None,
    #                   help="")
    #group.add_argument("--decoder-layer-to-infer", type=int, default=None,
    #                   help="if true, only builds a dictionary and then exits")
    add_common_eval_args(group)
